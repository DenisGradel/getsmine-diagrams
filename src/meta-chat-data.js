...
export const edges = [
  ["employee", "chat", "обычный вопрос"],
  ["project", "chat", "бизнес-контекст"],
  ["chat", "official", "рекламные факты"],
  ["official", "meta", "читает"],
  ["chat", "custom", "данные GetsMine"],
  ["custom", "pipedrive", "новые сделки"],
  ["custom", "crm", "качество и маршрут"],
  ["custom", "contextual", "по запросу"],
  ["official", "answer", "Meta-факты"],
  ["custom", "answer", "бизнес-факты"],
  ["chat", "answer", "объясняет"],
  ["answer", "decision", "рекомендация"],
  ["decision", "employee", "решение"],
  ["chat", "rollback", "только откат"],
  ["chat", "owners", "отдельное задание"],
];
